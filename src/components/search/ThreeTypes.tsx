    ...
    <>
        ...
        >
          <div
            ...
            style={chosenSearchType.car ? styleToApply : {
          ...
          >
            ...
            style={chosenSearchType.car ? { filter: "invert(37%) sepia(82%) saturate(4017%) hue-rotate(2deg) brightness(97%) contrast(112%)"}: {}}
            draggable={false}></img>
          </div>
          ...
          >
            <img
              src={tractorSVG}
              style={chosenSearchType.tractor ? { filter: "invert(37%) sepia(82%) saturate(4017%) hue-rotate(2deg) brightness(97%) contrast(112%)"}: {}}
              alt="Tractor icon"
          ...
          className={carSearchStyling['motorcycle-div']}
            style={chosenSearchType.motorcycle ? styleToApply : {
          ...
          >
            <img
              style={chosenSearchType.motorcycle ? { filter: "invert(37%) sepia(82%) saturate(4017%) hue-rotate(2deg) brightness(97%) contrast(112%)"}: {}}
              src={motorcycleSVG}
              alt="Motorcycle icon"
              draggable={false}
            ></img>
